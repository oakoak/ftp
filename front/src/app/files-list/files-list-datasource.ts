...
/**
 * Data source for the FilesList view. This class should
 * encapsulate all logic for fetching and manipulating the displayed data
 * (including sorting, pagination, and filtering).
 */
export class FilesListDataSource extends DataSource<FilesListItem> {
  data: FilesListItem[] = EXAMPLE_DATA;
   ...
   */
  connect(): Observable<FilesListItem[]> {
   ...
   */
  private getPagedData(data: FilesListItem[]): FilesListItem[] {
    if (this.paginator) {
   ...
   * this would be replaced by requesting the appropriate data from the server.
   */
  private getSortedData(data: FilesListItem[]): FilesListItem[] {
